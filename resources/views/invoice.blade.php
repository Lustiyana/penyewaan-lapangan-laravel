...
<body>
    ...
    <section id="header">
        <h1 class="py-3 text-center">data invoice anda</h1>
    </section>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-box success">
                                <a href="#" class="btn-booking success" style="color: aliceblue">Berhasil</a>
                            </div>
                        </td>
                        <td>
                            <a href="#"><img src="images/change_icon.svg" alt="edit"></a>
                            <a href="#"><img src="images/delete_icon.svg" alt="delete"></a>
                        </td>
                    </tr>
                </tbody>
            </table>
